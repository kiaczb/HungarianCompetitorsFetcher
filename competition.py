...
def GetCompetitionsWithHungarians(date):
    ...
    for comp, competitors in competition_results:
        if competitors:
...
def GetCompetitionIds(date):
        ...
        while not end:
            ...
            competitionsUrl = f"https://www.worldcubeassociation.org/api/v0/competitions?sort=start_date&start=2025-06-10&end=2025-07-27&page={pageCount}"
